...
HD_PWD='E:/work/tju/DE/Final/ball/project_1/project_1.runs/music_rom_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log music_rom_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source music_rom_1.tcl
