...
HD_PWD='E:/work/tju/DE/Final/ball/project_1/project_1.runs/music_lose_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log music_lose.vds -m64 -mode batch -messageDb vivado.pb -notrace -source music_lose.tcl
