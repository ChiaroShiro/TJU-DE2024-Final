...
#
# Generated by export_simulation on Sat Jan 04 18:11:06 +0800 2025
#
################################################################################
...
switch to the './music_crash.sh' script.

./music_crash.sh -reset_run
...
./music_crash.sh -noclean_files

For more information on the script, please type './music_crash.sh -help'.
